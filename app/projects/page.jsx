...
const projectData = [
  {
    ...
    description: 'Created using Next.js, TypeScript, and A.O.S library for component animations.',
    ...
    <section className="min-h-screen pt-12 ">
      <div className="container mx-auto">
        ...
        <Tabs defaultValue={category} className="mb-24 xl:mb-48">
          <TabsList className="w-full grid h-full md:grid-cols-3 lg:max-w-[640px] mb-12 mx-auto 
